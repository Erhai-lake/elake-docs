import{p as U}from"./chunk-OQCM5LHU.Bfc3PQfC.js";import{Y as y,P as G,aG as j,F as q,q as K,r as Y,s as Z,g as H,c as J,b as Q,_ as u,l as z,t as X,d as tt,G as et,K as at,a6 as rt,k as nt}from"../app.BgEExVjU.js";import{p as it}from"./gitGraph-YCYPL57B.CBAl2iOs.js";import{d as O}from"./arc.7nmnJgeV.js";import{o as st}from"./ordinal.BYWQX77i.js";import"./framework.BPErc-vJ.js";import"./theme.BRWr2ncu.js";import"./baseUniq.DP50JYdM.js";import"./isUndefined.CJrybPlc.js";import"./basePickBy.CYvyGO6s.js";import"./min.CAze_cLG.js";import"./clone.CWmSEJEc.js";import"./init.Gi6I4Gst.js";function ot(t,a){return a<t?-1:a>t?1:a>=t?0:NaN}function lt(t){return t}function ct(){var t=lt,a=ot,m=null,o=y(0),g=y(G),x=y(0);function i(e){var r,l=(e=j(e)).length,c,A,h=0,p=new Array(l),n=new Array(l),v=+o.apply(this,arguments),w=Math.min(G,Math.max(-G,g.apply(this,arguments)-v)),f,T=Math.min(Math.abs(w)/l,x.apply(this,arguments)),$=T*(w<0?-1:1),d;for(r=0;r<l;++r)(d=n[p[r]=r]=+t(e[r],r,e))>0&&(h+=d);for(a!=null?p.sort(function(S,C){return a(n[S],n[C])}):m!=null&&p.sort(function(S,C){return m(e[S],e[C])}),r=0,A=h?(w-l*$)/h:0;r<l;++r,v=f)c=p[r],d=n[c],f=v+(d>0?d*A:0)+$,n[c]={data:e[c],index:r,value:d,startAngle:v,endAngle:f,padAngle:T};return n}return i.value=function(e){return arguments.length?(t=typeof e=="function"?e:y(+e),i):t},i.sortValues=function(e){return arguments.length?(a=e,m=null,i):a},i.sort=function(e){return arguments.length?(m=e,a=null,i):m},i.startAngle=function(e){return arguments.length?(o=typeof e=="function"?e:y(+e),i):o},i.endAngle=function(e){return arguments.length?(g=typeof e=="function"?e:y(+e),i):g},i.padAngle=function(e){return arguments.length?(x=typeof e=="function"?e:y(+e),i):x},i}var R=q.pie,F={sections:new Map,showData:!1,config:R},b=F.sections,P=F.showData,pt=structuredClone(R),ut=u(()=>structuredClone(pt),"getConfig"),gt=u(()=>{b=new Map,P=F.showData,X()},"clear"),dt=u(({label:t,value:a})=>{b.has(t)||(b.set(t,a),z.debug(`added new section: ${t}, with value: ${a}`))},"addSection"),ft=u(()=>b,"getSections"),mt=u(t=>{P=t},"setShowData"),ht=u(()=>P,"getShowData"),I={getConfig:ut,clear:gt,setDiagramTitle:K,getDiagramTitle:Y,setAccTitle:Z,getAccTitle:H,setAccDescription:J,getAccDescription:Q,addSection:dt,getSections:ft,setShowData:mt,getShowData:ht},vt=u((t,a)=>{U(t,a),a.setShowData(t.showData),t.sections.map(a.addSection)},"populateDb"),St={parse:u(async t=>{const a=await it("pie",t);z.debug(a),vt(a,I)},"parse")},yt=u(t=>`
  .pieCircle{
